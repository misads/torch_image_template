...
from network.norm import InsNorm
...
class cleaner(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=1, padding=3)  # `SAME` padding
...
class DualUpDownLayer(nn.Module):
    def __init__(self, in_dim, out_dim, res_dim, f_size=3, dilation=1, norm_type="instance", with_relu=True):
        ...
        self.down_conv = ConvLayer(res_dim, res_dim, kernel_size=f_size, stride=1)
